...
function NotFound({ isBlur }) {
  return (
    <main className={`md:flex min-h-screen ${isBlur ? 'blur-sm' : 'blur-none'}`}>
      <div className="404 w-full mx-auto flex flex-row md:flex-col flex-wrap items-center justify-evenly md:justify-center space-y-6">
